...
class _ApiClient implements ApiClient {
  ...
  Future<NowPlayingMovies> getNowPlayingMovies() async {
    ...
    final _options = _setStreamType<NowPlayingMovies>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late NowPlayingMovies _value;
    try {
      _value = NowPlayingMovies.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<TrendingMoviesResponseModel> getPopularMovies() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TrendingMoviesResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
